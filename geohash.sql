...
CREATE FUNCTION `geohash_encode` (
    _latitude DOUBLE(9, 6),
    _longitude DOUBLE(9, 6),
    _precision TINYINT UNSIGNED
)
RETURNS VARCHAR(12)
DETERMINISTIC NO SQL
COMMENT 'geohash_encode(57.64911, 10.40744, 12) => u4pruydqqvqb'
BEGIN
    DECLARE latL DOUBLE(9, 6) DEFAULT -90.0;
    DECLARE latR DOUBLE(9, 6) DEFAULT 90.0;

    DECLARE lonT DOUBLE(9, 6) DEFAULT -180.0;
    DECLARE lonB DOUBLE(9, 6) DEFAULT 180.0;
    ...
    DECLARE mid DOUBLE(9, 6) DEFAULT NULL;
...
BEGIN
    ...
    DECLARE lat_err DOUBLE(9, 6) DEFAULT 90.0;
    DECLARE lon_err DOUBLE(9, 6) DEFAULT 180.0;
